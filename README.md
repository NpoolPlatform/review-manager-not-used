# Npool review manager

[![Test](https://github.com/NpoolPlatform/review-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/review-manager/actions/workflows/main.yml)
...
* make review-manager ```单独编译服务```
* make review-manager-image ```单独生成服务镜像```
